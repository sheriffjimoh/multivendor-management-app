<header class="main-header" >
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>DB Staff Board </b> </span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo (!empty($unirow['photo'])) ? '../images/'.$unirow['photo'] : '../images/profile.jpg'; ?>"  class="user-image" alt="jimoh sherifdeen"></span>
            </a>
