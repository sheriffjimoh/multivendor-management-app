              ...
              <table id="example1" class="table table-bordered  table-responsive">
                ...
                $conn= $obj->Connect();
                 ...
                 $obj= new Main;
                  ...
                  <a  class='btn btn-danger btn-sm  btn-flat' onclick='return confirm("are you sure you want to delete?");' href='../class/process/delete.php?del_product=<?php echo $id ?>' ><i class='fa fa-trash'></i> Delete</a>
