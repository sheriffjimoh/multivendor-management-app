...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <h2> <span style="font-family: alrgerian; color: navy; font-weight: bolder;">Edit account</span> </h2> 
            ...
            <div class="form-group">
                           <button type="submit" class="btn btn-success btn-flat" name="update_acc"><i class="fa fa-save"></i> update</button></div>
              </form></div>
  ...
  $sql=$conn->query("SELECT  * FROM panel");
          while ($row = $sql->fetch()) { ?>
                      <?php
                      ...
                      $id = $row['id'];?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['User_type']; ?></td>
                           ...
                           <td><span id="hide">******************** </span> 
                            <span id="show" style="display: none;"><?php  echo  $row['Password']; ?></span>
                             <a href="" id="eyeopen"><i  class="fa fa-eye pull-right"></i></a>

                           </td>
                          <td>
                  <a class='btn btn-success btn-sm  btn-flat' href='account.php?update_supplier=<?php echo $id ?>' ><i class='fa fa-edit'></i> Edit</a>
