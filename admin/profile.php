            ...
            <div class="box-body">
             <div class="card  col-sm-8  ">
              <div class="img-card col-sm-offset-4">
                <!-- <img src="../images/cover.jpeg" width="100%" class="card-img" style=""> -->
              </div>
                  <img src="<?php echo (!empty($row['photo'])) ? '../images/'.$row['photo'] : '../images/profile.jpg'; ?>" class="img-responsive img-circle col-sm-offset-7  col-xs-offset-5"  style="width: 120px;  text-align: center; margin-top: -50px;" >
                  ...
                  <li class="list-group-item"><span class="text-primary">username: </span> <?php echo  $username ?>
                   <span class="  pull-right"><i class="fa fa-check"></i></span></li> 
                    <li class="list-group-item"><span class="text-primary">user-id: </span><?php  echo  $row['User_id'] ?>  <span class="  pull-right"><i class="fa fa-check"></i></span></li> 
