    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="../class/process/action.php">
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="description" name="employee_id" required>
                    </div>
                </div>
          		  <div class="form-group">
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-primary btn-flat" name="add_deduction"><i class="fa fa-save"></i> Save</button>
            	</form>
          	</div>
        </div>
    </div>
