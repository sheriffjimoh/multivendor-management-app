    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="../class/process/position_add.php">
                ...
                <div class="form-group">
                    <label for="rate" class="col-sm-3 control-label">Salary per Hr/Mh</label>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-primary btn-flat" name="add_position"><i class="fa fa-save"></i> Save</button>
            	</form>
          	</div>
        </div>
    </div>
