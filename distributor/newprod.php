  ...
  <section class="content-header">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <ul class="list-group">
           ...
           $sql=$conn->query("SELECT  * FROM production  WHERE   Status='off' order by id desc ");
           if ($sql->rowCount() > 0) {
                     while ($row = $sql->fetch()) {?>
     ...
     <li class="list-group-item">Prod-price<span class="label label-info pull-right"><?php echo number_format($row['Prod_price'],2) ; ?></span></li>     
       ...
       <li class="list-group-item pull-right">  <a class='btn btn-warning btn-sm  btn-flat' href='../class/process/staff-update.php?prod_clear_id=<?php echo $id ?>' ><i class='fa fa-edit'></i>Clear</a>
                 
</li>  <br>               
                 <?php }     } else{?>
                  <h2 class="text-warning lead">Seems you have no pending production,  </h2>
