...
<header class="main-header"  style="background-color:#85867585;">
    ...
    <a href="home.php" class="logo" style="background-color:#85867585;">
      ...
      <span class="logo-lg"><b>Danjuma Bakery</b> Staff Board  </span>
    </a>

    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color:#85867585; position:">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
        <span class="sr-only">Toggle navigation</span>
      </a>

          <a href="#Book" data-toggle="modal" class="btn btn-default btn-sm btn-flat " style="margin-left: 30%;  margin-top: 10px;"><i class="fa fa-plus"></i> New Book</a>
