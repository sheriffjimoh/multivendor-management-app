      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <ul class="list-group">
               ...
               $empty ="";
           $sql=$conn->query("SELECT  * FROM supply  WHERE  Status='on' and Payment='on' AND Supplier='$userid' and Balance !=0 order by id desc ");
               if ($sql->rowCount() > 0 ) {     
                     while ($row = $sql->fetch()) {
               $balance = $row['Balance'];
       ...
       <li class="list-group-item">Balance-amount<span class="label label-info pull-right"><?php echo  number_format( $balance,2);   ?></span></li>           <li class="list-group-item">Date<span class="label label-info pull-right"><?php echo date('M d, Y', strtotime($row['Date']))?></span></li>  
      <br>     
              <?php  }  } else{?>
                  ...
                  <li class="list-group-item">Step 2: Visit our office , meet distributor for visual clearification! </li>
