...
.table-responsive{
 ...
 echo "<br>";
           ...
           if ($sql->rowCount() > 0) {
                     $row = $sql->fetch();?>
                     <br>
                 <li class="list-group-item">Produt-name <span class="label label-primary pull-right"><?php echo $row['Prod_name']  ?></span>   </li>
                  <li class="list-group-item">Produt-size <span class="label label-primary pull-right"><?php echo $row['prod_size']  ?></span>   </li>
                   <li class="list-group-item">Produt-price <span class="label label-primary pull-right"><?php echo number_format( $row['Prod_price'],2); ?></span>   </li>
                     <li class="list-group-item">Produt-peices-vailable <span class="label label-primary pull-right"><?php 
                     echo (!empty($row['Remain'])) ? $row['Remain'] : 0;  ?></span>   </li>
             
          <?php }else{?>
     
               <h2 class="text-warning lead">Seems this product as not added,  </h2>
