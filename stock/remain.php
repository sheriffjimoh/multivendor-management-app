        ...
        <div class="col-xs-12">
          <div class="box">
            <div class='alert alert-info alert-dismissible'>
             ...
             Hi, Here you can view all available stock.
            </div>
            <div class="box-body">
          ...
          <ul class="list-group">
            ...
            $sql=$conn->query("SELECT  * FROM store where Status='on' order by id desc ");
           if ($sql->rowCount() > 0) {
                   while ($row = $sql->fetch()) {?>
                     <br>
                 ...
                 <li class="list-group-item">Item-name <span class="label label-primary pull-right"><?php echo $row['Item_name']  ?></span>   </li>
                  <li class="list-group-item">Quantity <span class="label label-primary pull-right"><?php echo $row['Quantity']  ?></span>   </li>
                   ...
                   <li class="list-group-item">Remain<span class="label label-primary pull-right"><?php
                    $remain = $row['Remain'];
                   if ($remain=='off') {
                   $remain = $row['Quantity'];
                   }else{
